#!/usr/bin/env python3
"""
GitHub Workflow Permissions Verification Script
...
This tool helps maintain compliance with the Token-Permissions security check.
...
Usage:
    python verify_workflow_permissions.py [directory]
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Verify GitHub workflow permissions compliance with OpenSSF Scorecard recommendations",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
    python verify_workflow_permissions.py
    python verify_workflow_permissions.py /path/to/repo
    python verify_workflow_permissions.py --quiet
    python verify_workflow_permissions.py --help
        """
    )
